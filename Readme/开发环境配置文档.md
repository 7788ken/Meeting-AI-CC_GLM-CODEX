...
6. **访问后端API**
   - API地址：`http://localhost:5181/api`
   - Swagger文档：`http://localhost:5181/api/docs`
...
| `VITE_API_BASE_URL` | 前端API基础URL | http://localhost:5181/api |
| `VITE_WS_URL` | WebSocket连接URL | ws://localhost:5181/transcript |
