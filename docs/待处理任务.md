...
transcription.ts:305 [Transcription] 状态消息 {sessionId: '979bb2ea-ec2a-45dc-a496-a5666302a9c9', status: 'session_set'}
http.ts:56  PUT http://localhost:5181/api/app-config 400 (Bad Request)
...
put @ http.ts:68
update @ api.ts:410
updateBackendConfig @ useBackendConfig.ts:371
await in updateBackendConfig
syncBackendConfig @ SettingsDrawer.vue:2023
onSave @ SettingsDrawer.vue:2054
await in onSave
...
http.ts:47 [API Error] Bad Request Exception
(匿名) @ http.ts:47
Promise.then
_request @ Axios.js:163
request @ Axios.js:40
